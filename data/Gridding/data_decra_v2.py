...
# %%
# get M01's mjd & ra & dec (average dec):
def M01_baseline_sim(pos_mjd,pos_ra,pos_dec,drift_dec_date):
...
# %%
def get_beam_sim(ra_fun,dec_fun,drift_dec_date,crafts_mjd,pos_dec):
...
def calibration(pos_mjd,pos_ra,pos_dec,drift_dec_date):
...
#     for f in filelist:
#         pos_mjd,pos_ra,pos_dec = get_position(f)
#         ra_fun,dec_fun,crafts_mjd = M01_baseline_sim(pos_mjd,pos_ra,pos_dec,f)
#         all_coords_dec,all_coords_ra = get_beam_sim(ra_fun,dec_fun,f,crafts_mjd,pos_dec)
#         save_dec_ra(f,all_coords_dec,all_coords_ra)

#         print("{} finished ======√".format(f))

def main():
    filelist = ['Dec+4037_10_05_20211001','Dec+4059_10_05_20210930','Dec+4120_10_05_20210929']
    for f in filelist:
        pos_mjd,pos_ra,pos_dec = get_position(f)
        calibration(pos_mjd,pos_ra,pos_dec,f)
